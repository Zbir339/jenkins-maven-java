...
public class Duree {   //
    ...
    public void setMinutes(int minutes,boolean next) {
        if (minutes >= 0 && next && minutes <= 60) {
            this.minutes = minutes;
        } else {
            throw new IllegalArgumentException("Les minutes doivent être entre 0 et 59.");
        }
    ...
    // j'ai surcharger une methode pour ne pas avoir un chauvauchement des methodes
    public void setSecondes(int secondes,boolean next) {
        if (secondes >= 0 && next && secondes <= 60) {
            this.secondes = secondes;
        } else {
            throw new IllegalArgumentException("Les secondes doivent être entre 0 et 59.");
        }
    ...
    // Formatte la durée en hh:mm:ss   02:30:23
    ...
    public void nextSeconde() {
        this.setSecondes((this.getSecondes() + 1),true);
    ...
    public void nextMinute() {
        this.setMinutes((this.getMinutes() + 1),true);
